...
function Home() {
  ...
  if (loading) {
    return (
      <div className="text-center py-20 font-bold text-[#64748B]">
        Loading...
      </div>
    );
  }
  ...
  return (
    <section className="w-full bg-[#F8FAFC] py-16 px-6">
      <div className="max-w-[1600px] mx-auto flex flex-col items-center">
        <h2 className="text-3xl md:text-5xl font-bold text-[#1E293B] text-center mb-4 tracking-tight">
        ...
        <button className="flex items-center gap-2 bg-[#244D3F] hover:bg-[#1b3a30] text-white px-6 py-3 rounded font-semibold text-sm md:text-base transition-colors mb-16 shadow-sm">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="bg-white border border-[#E2E8F0] rounded-xl p-8 flex flex-col items-center justify-center min-h-[160px] shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
            <span className="text-4xl md:text-5xl font-semibold text-[#244D3F] mb-3">
              {totalFriends}
            </span>
